...
<script>
var webSocket 
	= new WebSocket("ws://localhost:8081/WebsocketProject/ChatingServer");
...
function sendMessage(){
	...
	chatMessage.value= ""; //메시지입력창 내용 지우기
	chatWindow.scrollTop = chatWindow.scrollHeight; //대화창 스크롤 자동 이동
}
...
<style> 
#chatWindow{border:1px solid black; width:270px; height:400px; overflow:scroll; padding:5px;}
