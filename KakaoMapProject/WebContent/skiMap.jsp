...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=65b98c8c559b107393d8d9bf9f356bf1"></script>
<script>
...
content += '    <a href="https://place.map.kakao.com/27409341" target="_blank"><strong>오투리조트 C.C	</strong></a>';
content += '    <div class="desc">';
content += '        <img src="" alt="">';
content += '        <span class="address">강원도 태백시 서학로 861 (황지동,오투리조트)</span>';
content += '    </div>';
content += '</div>';
